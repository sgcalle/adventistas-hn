...
class AccountJournal(models.Model):
    ...
    def _get_defualt_surcharge_product_id(self):
        product_id = int(self.env["ir.config_parameter"].get_param('pos_payment_registeter.surcharge_product_id'))
    ...
    surcharge_amount = fields.Monetary(default=lambda journal: journal.env["ir.config_parameter"]
                                            .get_param('pos_payment_registeter.surcharge_default_amount'))
